...
/// <see cref="DateTimeUtilityValidation"/> validation results.
/// </summary>
/// <remarks>
/// <see cref="DateTimeUtilityValidation"/> is a static validation helper with no instance state,
/// so this class serializes the read-only list of validation error messages it produces,
/// enabling consistent JSON handling of date/time validation results across the application.
/// </remarks>
public static class DateTimeUtilityValidationJsonExtensions
{
    /// <summary>
    ...
    /// <summary>
    /// Serializes a <see cref="DateTimeUtilityValidation"/> validation result to a JSON string.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a JSON string into a <see cref="DateTimeUtilityValidation"/> validation result.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string into a <see cref="DateTimeUtilityValidation"/> validation result.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    ...
    /// <summary>
    /// Data Transfer Object for date/time validation result messages.
    /// </summary>
