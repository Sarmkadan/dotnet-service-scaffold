...
/// <see cref="PerformanceUtilityValidation"/> validation results.
/// </summary>
/// <remarks>
/// <see cref="PerformanceUtilityValidation"/> is a static validation helper with no instance state,
/// so this class serializes the read-only list of validation error messages it produces,
/// enabling consistent JSON handling of performance validation results across the application.
/// </remarks>
public static class PerformanceUtilityValidationJsonExtensions
{
    /// <summary>
    ...
    /// <summary>
    /// Serializes a <see cref="PerformanceUtilityValidation"/> validation result to a JSON string.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a JSON string into a <see cref="PerformanceUtilityValidation"/> validation result.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string into a <see cref="PerformanceUtilityValidation"/> validation result.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    ...
    /// <summary>
    /// Data Transfer Object for performance validation result messages.
    /// </summary>
