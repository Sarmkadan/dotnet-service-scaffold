...
public class ServiceMetric : IServiceMetric, IEquatable<ServiceMetric>
{
    ...
    public override string ToString() => $"ServiceMetric {{ Id = {Id}, ServiceId = {ServiceId}, RecordedAt = {RecordedAt:u}, CpuUsagePercent = {CpuUsagePercent}%, MemoryUsagePercent = {MemoryUsagePercent}%, DiskUsagePercent = {DiskUsagePercent}%, AvgResponseTime = {AverageResponseTimeMs}ms, Req/Sec = {RequestsPerSecond}, TotalReq = {TotalRequests}, Errors = {ErrorCount} }}";
}
