...
public class MetricsService : IMetricsService
{
    ...
    public Task<Dictionary<string, object>> GetMetricsAsync()
    {
        ...
        foreach (var kvp in _metrics)
        {
            ...
            var metricData = metric.Type switch
            {
                MetricType.Counter => new { type = "counter", value = metric.Value },
                MetricType.Gauge => new { type = "gauge", value = metric.Value },
                ...
                _ => new { type = "unknown", value = metric.Value }
            };
    ...
    /// </summary>
    private string BuildMetricKey(string metricName, IDictionary<string, string>? tags)
    {
